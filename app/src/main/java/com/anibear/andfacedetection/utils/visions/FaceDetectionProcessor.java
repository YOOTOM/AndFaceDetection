...
package com.anibear.andfacedetection.utils.visions;
...
import com.anibear.andfacedetection.utils.common.CameraImageGraphic;
...
import com.anibear.andfacedetection.utils.common.VisionProcessorBase;
...
public class FaceDetectionProcessor extends VisionProcessorBase<List<FirebaseVisionFace>> implements FaceDetectStatus {
    ...
    protected void onSuccess(
        ...
        for (int i = 0; i < faces.size(); ++i) {
            ...
            int cameraFacing =
                    frameMetadata != null ? frameMetadata.getCameraFacing() : CameraSource.CAMERA_FACING_BACK;
